...
window.appPeriodComp = {
    ...
    props: ["event", "settings", "ui"],
    methods: {
        isSelected: function() {
            //return this.ui.selectedType === 1 && this.ui.selectedYear === this.years[this.yearindex] && this.ui.selectedIndex === this.index;
        }
    }
}
window.appYearComp = {
